...
- Sorgente:     192.168.13.132
- Destinazione: 192.168.13.130
- Interfaccia:  eth0
...
# === Parametri ===========
SRC_IP  = "192.168.13.132"   # IP sorgente (richiede privilegi per impostarlo a mano)
DST_IP  = "192.168.13.130"   # IP destinazione
